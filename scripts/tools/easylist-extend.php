...
$ARR_REGEX_LIST = [
    ...
    '/^([^\s\/]+\.)?syma[a-z]\.cn$/' => null,
    //'/^([^\s\/]+\.)?widgets?\./' => null, // #1071
    '/^([^\s\/]+\.)?(webstats?|swebstats?|mywebstats?)\./' => null, // #366
    //'/^([^\s\/]+\.)?track(ing)?\./' => null,
    '/^([^\s\/]+\.)?tongji\./' => null,
    '/^([^\s\/]+\.)?toolbar\./' => null,
    ...
    //'/^([^\s\/]+\.)?[0-9a-z]{16,}\.xyz$/' => null, //16個字符以上的.xyz域名  // #980 #1101
...
$ARR_WHITE_RULE_LIST = [
    ...
    //'@@||widget.1688.com^' => 1, // #469 // #1071
    '@@||analytics.google.com^' => 1,
    //'@@||widget.gleamjs.io^' => 1, // #472 // #1071
    ...
    //'@@||widget.ezidebit.com.au^' => 1, // #834 // #1071
    //'@@||widget.rave.office.net^' => 1, // #837 // #1071
    //'@@||widget.sndcdn.com^' => 1, // #839 // #1071
    '@@||ad.nl^' => 1, // #841
